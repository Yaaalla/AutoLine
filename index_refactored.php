<?php
/**
 * AutoLine - Main Index Page
 * 
 * الصفحة الرئيسية - Landing page للموقع
 * 
 * @package AutoLine\Public
 */
...
// Set page variables
$page_title = "اوتو لاين لتأجير السيارات";
$meta_desc = "أفضل خدمة تأجير سيارات في مصر - تشكيلة واسعة من السيارات الحديثة والفاخرة بأسعار تنافسية";
...
<section class="py-24 px-6 lg:px-20 bg-slate-50 dark:bg-[#111]">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <a href="<?= Config::getUrls()['base'] ?>/Modules/Cars/index.php" class="bg-white dark:bg-[#1a1a1a] p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-white/5 hover:border-primary/50 transition-all hover:-translate-y-2 group block">
            ...
            <a href="<?= Config::getUrls()['base'] ?>/Modules/Cars/index.php" class="bg-white dark:bg-[#1a1a1a] p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-white/5 hover:border-primary/50 transition-all hover:-translate-y-2 group block">
                ...
                <p class="text-slate-600 dark:text-slate-400 text-lg">لعشاق السسرعة والأداء العالي.</p>
            </a>
            <a href="<?= Config::getUrls()['base'] ?>/Modules/Cars/index.php" class="bg-white dark:bg-[#1a1a1a] p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-white/5 hover:border-primary/50 transition-all hover:-translate-y-2 group block">
                <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
...
<section class="py-24 px-6 lg:px-20 bg-primary relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <a href="<?= Config::getUrls()['base'] ?>/Modules/Cars/index.php" class="bg-white text-primary hover:bg-slate-900 hover:text-white px-12 py-5 rounded-xl font-black text-xl transition-all shadow-2xl inline-flex items-center gap-3 transform hover:-translate-y-1">
...
<section id="fleet" class="py-24 px-6 lg:px-20 bg-white dark:bg-background-dark">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="group bg-slate-50 dark:bg-surface rounded-3xl overflow-hidden shadow-sm border border-gray-100 dark:border-white/5 hover:border-primary/50 transition-all hover:shadow-2xl dark:hover:shadow-primary/5">
                ...
                <div class="p-8">
                    ...
                    <a href="<?= Config::getUrls()['base'] ?>/Modules/Booking/Flow.php?car_id=<?= $car['id'] ?>" class="block w-full bg-slate-100 dark:bg-[#1a1a1a] text-slate-900 dark:text-white hover:bg-primary hover:text-white dark:hover:bg-primary py-4 rounded-xl text-xl font-bold transition-all text-center shadow-sm">
                        احجز الان
                    </a>
                </div>
            </div>
        ...
        <div class="text-center mt-16">
            <a href="<?= Config::getUrls()['base'] ?>/Modules/Cars/index.php" class="inline-flex items-center gap-3 border-2 border-primary text-primary hover:bg-primary hover:text-white px-10 py-4 rounded-xl font-bold text-lg transition-all">
...
<section id="blog" class="py-24 px-6 lg:px-20 bg-slate-50 dark:bg-[#111]">
    <div class="max-w-7xl mx-auto">
                ...
                <article class="bg-white dark:bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-lg border border-gray-100 dark:border-white/5 group transform hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div class="p-8">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4 hover:text-primary transition-colors leading-snug">
                            <a href="<?= Config::getUrls()['base'] ?>/Modules/Blog/detail.php?id=<?= $blog_post['id'] ?>"><?= htmlspecialchars($blog_post['title']) ?></a>
                        </h3>
                        <p class="text-slate-600 dark:text-slate-400 mb-6 line-clamp-3 text-lg">
                            <?= htmlspecialchars($blog_post['excerpt']) ?>
                        </p>
                        <a href="<?= Config::getUrls()['base'] ?>/Modules/Blog/detail.php?id=<?= $blog_post['id'] ?>" class="inline-flex items-center gap-2 text-primary font-bold hover:text-slate-900 dark:hover:text-white transition-colors group-hover:gap-3">
                            اقرأ المزيد 
        ...
        <div class="text-center mt-12">
            <a href="<?= Config::getUrls()['base'] ?>/Modules/Blog/index.php" class="inline-flex items-center gap-2 px-8 py-3 rounded-xl border border-primary text-primary hover:bg-primary hover:text-[#12110f] transition-all font-bold">
