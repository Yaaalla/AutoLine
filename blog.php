            ...
            <?php else: ?>
                ...
                <article class="bg-white dark:bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-lg border border-gray-100 dark:border-white/5 group transform hover:-translate-y-2 transition-all duration-300 flex flex-col h-full">
                    ...
                    <div class="p-8 flex flex-col flex-1">
                        ...
                        <a href="blog_details.php?id=<?= $blog_post['id'] ?>" class="inline-flex items-center gap-2 text-primary font-bold hover:text-slate-900 dark:hover:text-white transition-colors group-hover:gap-3 mt-auto pt-4 border-t border-gray-100 dark:border-white/5">
                            اقرأ المزيد 
