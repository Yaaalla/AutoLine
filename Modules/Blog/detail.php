<?php
/**
 * AutoLine - Blog Detail
 * 
 * صفحة تفاصيل المقال - عرض مقال محدد
 * 
        ...
        <div class="lg:w-1/3 space-y-8">
            <div class="bg-white dark:bg-[#1a1a1a] p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5">
                ...
                <div class="space-y-6">
                    ...
                    <a href="detail.php?id=<?= $rb['id'] ?>" class="flex gap-4 group">
            ...
            <div class="bg-primary p-8 rounded-3xl shadow-xl text-center relative overflow-hidden">
                ...
                <a href="<?= Config::getUrls()['base'] ?>/Modules/Cars/index.php" class="inline-block bg-[#12110f] text-white px-8 py-3 rounded-xl font-bold hover:bg-slate-800 transition-colors shadow-lg w-full">
                    تصفح أسطول السيارات
                </a>
            </div>
        </div>
