<?php
/**
 * AutoLine - Car Details
 * 
 * صفحة تفاصيل السيارة - عرض معلومات سيارة محددة
 * 
...
// Set page variables
$page_title = $car['brand'] . ' ' . $car['model'] . ' ' . $car['model_year'];
$meta_desc = "تفاصيل سيارة " . $car['brand'] . " " . $car['model'] . " - متاحة للإيجار في اوتو لاين";
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="flex flex-col">
                <nav class="flex items-center gap-2 text-xs font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">
                    <a href="<?= Config::getUrls()['base'] ?>/index.php">الرئيسية</a>
                    <span class="material-symbols-outlined text-[10px]">chevron_left</span>
                    <a href="<?= Config::getUrls()['base'] ?>/Modules/Cars/index.php">الأسطول</a>
                    <span class="material-symbols-outlined text-[10px]">chevron_left</span>
                ...
                <div class="mt-auto bg-slate-50 dark:bg-[#1c1a17] p-8 rounded-3xl border border-primary/10">
                    ...
                    <?php else: ?>
                        <a href="<?= Config::getUrls()['base'] ?>/Modules/Booking/Flow.php?car_id=<?= $car['id'] ?>" class="w-full bg-primary hover:bg-primary/90 text-background-dark py-4 rounded-xl font-black uppercase tracking-widest transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2 mt-4 text-center">
                            احجز هذه السيارة
                ...
                <div class="group bg-slate-50 dark:bg-[#2a241c] rounded-xl border border-primary/10 hover:border-primary/40 transition-all overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center mt-2">
                            ...
                            <a href="detail.php?id=<?= $other['id'] ?>" class="text-[10px] font-bold uppercase text-slate-500 hover:text-primary underline">عرض التفاصيل</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
